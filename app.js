(function () {
  ...
  function bindSetupWizard() {
    ...
    next.addEventListener("click", function () {
      ...
      if (cur >= stepEls.length) {
        setStatus("Kurulum tamamlandı. Katalogdan uygulamayı seç ve başlat.");
  ...
  function initComments(gameId) {
    ...
    var html =
      ...
      "</div>" +
      '<p class="support-sub">Uygulamayı deneyenlerle yorumlaş. Supabase anahtarı verilirse bu alan tüm ziyaretçilerin ortak canlı sohbetine dönüşür (kod hazır).</p>' +
